...
| **破解 Transformer 系列** | 不是「教学」而是「破解」：还原被论文拆掉的历史脚手架 —— 从机器翻译源头讲起，规则系统 → 统计语言 → 端到端 → RNN 到 Transformer（视频系列配套笔记） | [阅读](https://ytwangdongsheng.github.io/knowledge-hub/transformer-series/) |
