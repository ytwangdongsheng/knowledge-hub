...
| **破解 Transformer 系列** | 不是「教学」而是「破解」：还原被论文拆掉的历史脚手架。已完成两讲 —— 第 1 讲论文为什么难懂、第 2 讲规则系统为什么必然失败（视频系列配套笔记） | [阅读](https://ytwangdongsheng.github.io/knowledge-hub/transformer-series/) |
